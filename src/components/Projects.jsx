 ...
 const [currentIndex, setCurrentIndex] = useState(0);
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Where vision meets property - Explore Our Work</p>
            ...
            <div className='flex gap-8 transition-transform duration-500 ease-in-out'>
                {projectsData.map((project, index) => (
                    ...
                    style={{ transform: `translateX(-${currentIndex * (100 / cardsToShow)}%)` }}>
                        <img src={project.image} alt={project.title} className='h-80 w-full mb-14'/>
